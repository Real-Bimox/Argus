...
def _build_prompt(direction: str, n: int) -> str:
    return (
        ...
        "mathematical derivation only for mathematical claims and physical derivation "
        "only for physical domains; reject decorative equations.\n\n"
        ...
        "derived predictions; no decorative math>\n\n"
