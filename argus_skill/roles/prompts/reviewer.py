...
def render_reviewer_prompt(
    ...
    *,
    ...
    rollback_block = (
        ...
        "return `replan_requested` with the earliest stage and evidence; Manager owns it. "
    ...
    static = (
        ...
        "only claim-critical uncertainty and never edit the work. Use `continue` for one "
        ...
        "or threshold miss is not impossibility. Give one highest-impact NEXT_ACTION. "
