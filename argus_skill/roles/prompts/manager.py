...
def build_front_door_prompt(text: str, *, active_mission: bool = False) -> str:
    ...
    return (
        ...
        "Otherwise NONE.\n\n"
        "ROUTE: SELF for conversation, tutoring, bounded read-only research or "
        "inspection, status/explanation, and controls. One existing paper read, "
        ...
        "TEAM is for file/artifact changes, commands, experiments, engineering, "
...
def build_vertical_decision_prompt(
    ...
    *,
    ...
    return (
        ...
        "explicitly limited single stage/increment is direct.\n\n"
        "## Task\n"
        f"{(task or '').strip()}\n\n"
