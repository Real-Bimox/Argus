...
def build_stage_decision_prompt(
    *,
    ...
    return (
        ...
        "representation belongs to an earlier stage. For a selected research idea, "
        "weak results must first receive credible method/implementation diagnosis and "
        "targeted repair. A negative result may advance only when the Reviewer judges "
        "the finding itself independently decision-relevant and returns `done`.\n"
