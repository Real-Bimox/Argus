...
def build_vertical_decision_prompt(
    ...
    *,
    ...
    return (
        ...
        "First inspect only the repository evidence needed to route correctly: one "
        "focused batch, at most four file/search operations. Treat all artifacts as "
        "READ-ONLY; do not edit files, choose Live View content, or perform the task.\n\n"
