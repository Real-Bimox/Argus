...
\hypersetup{
  pdftitle={\systemname: A General-Purpose Agentic Reasoning Runtime for Long-Horizon Tasks: Evidence-Governed Hierarchical Pivoting over Durable State},
...
\noindent{\raggedright\sffamily\fontsize{13}{16}\selectfont\bfseries\color{argusdeep}
  Evidence-Governed Hierarchical Pivoting over Durable State}\par
\vspace{0.06in}
\noindent{\raggedright\sffamily\small\color{ink}
  Boxiu Li\textsuperscript{1,2,$\ast$,$\S$},
  Zimo Wen\textsuperscript{2,$\ast$,$\S$},
  Yijia Fan\textsuperscript{1,$\ast$,$\S$},
  Junxiang Lei\textsuperscript{3,$\ddagger$},
  Sufeng Guo\textsuperscript{4,$\ddagger$},
  Jiaao Wu\textsuperscript{5,$\ddagger$},
  Ruize Tang\textsuperscript{1,$\ddagger$},
  Mukai Li\textsuperscript{6},
  Yifei Shen\textsuperscript{1},
  Xiaoyu Chen\textsuperscript{2},
  Wanbo Zhang\textsuperscript{3},
  Runjing Gu\textsuperscript{2},
  Yifei Gao\textsuperscript{2},
  Yuheng Wu\textsuperscript{2},
  Xuyao Huang\textsuperscript{2},
  Zelong Zhao\textsuperscript{7},
  Jiachen Zhang\textsuperscript{7},
  Sihan Chen\textsuperscript{2},
  Shibo Hu\textsuperscript{8},
  Hangxi Guo\textsuperscript{9},
  Yilin Chen\textsuperscript{10},
  Yuzhe Zhang\textsuperscript{2},
  Fan Yang\textsuperscript{1},
  Chuan Wen\textsuperscript{2},
  Xian Zhang\textsuperscript{1,$\dagger$},
  Xuanhe Zhou\textsuperscript{2},
  Zhijie Deng\textsuperscript{2,$\dagger$}\par}
\vspace{0.06in}
\noindent{\raggedright\sffamily\footnotesize\color{muted}
  \textsuperscript{1}Microsoft \enspace
  \textsuperscript{2}Shanghai Jiao Tong University \enspace
  \textsuperscript{3}Fudan University \enspace
  \textsuperscript{4}Nanjing University \enspace
  \textsuperscript{5}Tsinghua University \enspace
  \textsuperscript{6}The University of Hong Kong \enspace
  \textsuperscript{7}Independent Researcher \enspace
  \textsuperscript{8}Peking University \enspace
  \textsuperscript{9}The Chinese University of Hong Kong, Shenzhen \enspace
  \textsuperscript{10}Donghua University\par}
\vspace{0.045in}
\noindent{\raggedright\sffamily\footnotesize\color{muted}
  \textsuperscript{$\ast$}Co-first Authors \quad
  \textsuperscript{$\ddagger$}Co-contributors \quad
  \textsuperscript{$\S$}Co-project Leaders \quad
  \textsuperscript{$\dagger$}Corresponding Authors:
  \href{mailto:zhxian@microsoft.com}{zhxian@microsoft.com},
  \href{mailto:zhijied@sjtu.edu.cn}{zhijied@sjtu.edu.cn}\par}
\vspace{0.085in}
